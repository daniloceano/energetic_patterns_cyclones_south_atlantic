...
#                                                                              #
#                                                         :::      ::::::::    #
#    plot_lec_eofs_with_track_id.py                     :+:      :+:    :+:    #
#                                                     +:+ +:+         +:+      #
#    By: daniloceano <danilo.oceano@gmail.com>      +#+  +:+       +#+         #
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2024/03/05 09:22:16 by daniloceano       #+#    #+#              #
#    Updated: 2025/01/27 19:06:11 by daniloceano      ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
def main():
    ...
    eofs_path = '../csv_eofs_energetics_with_track'
    output_directory = '../figures_statistics_energetics/eofs_with_track/'
    ...
    for phase in phases:
        ...
        for mode in ['', '_with_mean']:
            ...
            explained_variance = pd.read_csv(os.path.join(phase_directory, 'variance_fraction.csv'))
